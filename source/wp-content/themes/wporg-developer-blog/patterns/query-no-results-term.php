<?php
/**
 * Title: No results message (term)
 * Slug: wporg-developer-blog/query-no-results-term
 */
...
<div class="wp-block-group" style="padding-top:10px;padding-bottom:10px">
	...
	<h2 class="wp-block-heading has-heading-3-font-size"><?php esc_html_e( 'There no posts with this term', 'wporg' ); ?></h2>
	<!-- /wp:heading -->
